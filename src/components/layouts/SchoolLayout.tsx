...
const navigation = [
  { name: 'Dashboard', href: '/school/dashboard', icon: BarChart3 },
  { name: 'Students', href: '/school/students', icon: Users },
  { name: 'Teachers', href: '/school/teachers', icon: GraduationCap },
  { name: 'Attendance', href: '/school/attendance', icon: QrCode },
];
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="w-64 bg-card border-r border-border card-shadow">
        <div className="p-6">
          <h2 className="text-xl font-bold text-primary">School Portal</h2>
